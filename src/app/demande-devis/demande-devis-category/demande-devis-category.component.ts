...
@Component({
  selector: 'app-demande-devis-category',
  templateUrl: './demande-devis-category.component.html',
  styleUrls: ['./demande-devis-category.component.css']
})
export class DemandeDevisCategoryComponent implements OnInit {
  ...
  ngOnInit() {
   ...
   this.countries$.subscribe(countries => console.log('all countries', countries))
    ...
    this.selectedCategory = this.route.snapshot.paramMap.get('label')
